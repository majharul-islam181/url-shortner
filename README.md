...
```sh
git clone https://github.com/majharul-islam181/url-shortner
```
...
```sh
curl -X POST http://localhost:8080/shorten -H "Content-Type: application/json" -d '{"url": "https://www.linkedin.com/in/majharul-islam181"}'
```
...
```json
{
    "short_url": "https://www.linkedin.com/in/majharul-islam181"
}
```
...
```sh
curl http://localhost:3000/redirect/98734788
```
